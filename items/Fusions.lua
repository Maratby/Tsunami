...
SMODS.Joker {
	...
	name = "Soaked Joker",
	atlas = "Tsunami",
	attributes = {"passive","mult", "extra_scored_cards"},
	rarity = "fusion",
	unlocked = true,
	discovered = true,
	blueprint_compat = true,
...
SMODS.Joker {
	key = 'holy_water',
	atlas = "Tsunami",
	attributes = {"passive","hand_type, mult"},
	pos = { x = 2, y = 0 },
	cost = 12,
	rarity = "fusion",
	unlocked = true,
...
SMODS.Joker {
	...
	atlas = "Tsunami",
	attributes = {"passive","xmult","chance", "extra_scored_cards"},
	pos = { x = 4, y = 2 },
	loc_vars = function(self, info_queue, card)
...
SMODS.Joker {
	...
	atlas = "Tsunami",
	attributes = {"passive","xmult","face", "extra_scored_cards"},
	rarity = "fusion",
	unlocked = true,
	discovered = true,
	blueprint_compat = true,
...
SMODS.Joker {
	...
	atlas = "Tsunami",
	attributes = {"passive","mult", "discard"},
	rarity = "fusion",
	unlocked = true,
	discovered = true,
	blueprint_compat = true,
...
SMODS.Joker {
	...
	name = "Smart Water",
	atlas = "Tsunami",
	attributes = {"passive","xmult", "mult", "ace"},
	rarity = "fusion",
	unlocked = true,
	discovered = true,
	blueprint_compat = true,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","modify_card","perma_bonus", "extra_scored_cards"},
	pos = { x = 0, y = 11 },
	cost = 16,
	config = { extra = 5 },
	loc_vars = function(self, info_queue, card)
...
SMODS.Joker {
	...
	key = "beach_ball",
	atlas = "Tsunami",
	attributes = {"passive","chance","generation"},
	pos = { x = 0, y = 5 },
...
SMODS.Joker {
	...
	perishable_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","ace","two","three","five","eight","mult","extra_scored_cards"},
	pos = { x = 1, y = 5 },
...
SMODS.Joker {
	...
	perishable_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","queen","mult","xmult"},
	pos = { x = 2, y = 6 },
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","nine","full_deck","economy"},
	pos = { x = 7, y = 12 },
	cost = 18,
...
SMODS.Joker {
	...
	rarity = "fusion",
	atlas = 'Tsunami',
	attributes = {"passive","extra_scored_cards","mult","food"},
	pos = { x = 7, y = 6 },
	cost = 18,
	discovered = true,
	eternal_compat = false,
...
SMODS.Joker {
	...
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","xmult","food","scaling"},
	pos = { x = 5, y = 11 },
	loc_vars = function(self, info_queue, card)
		local new_numerator, new_denominator = SMODS.get_probability_vars(card, 1, card.ability.extra.odds,
			'tsun_plantation')
...
SMODS.Joker {
	...
	perishable_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","suit","clubs","xmult"},
	pos = { x = 4, y = 4 },
...
SMODS.Joker {
	...
	pos = { x = 3, y = 5 },
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","chance","hand_type"},
...
SMODS.Joker {
	...
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","xmult","scaling","skip"},
	pos = { x = 5, y = 7 },
	calculate = function(self, card, context)
		if context.joker_main then
			return {
	...
	set_ability = function(self, card, initial, delay_sprites)
		G.GAME.skips = G.GAME.skips or 0
...
SMODS.Joker {
	...
	discovered = true,
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","face","retrigger"},
	blueprint_compat = true,
	pos = { x = 3, y = 1 },
	cost = 17,
	config = { extra = 1 },
...
SMODS.Joker {
	...
	---atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","economy"},
	pos = { x = 5, y = 1 },
	cost = 1,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","hands","economy","discards"},
	pos = { x = 1, y = 10 },
	cost = -10,
...
SMODS.Joker {
	...
	name = "SCUBA Mask",
	atlas = "Tsunami",
	attributes = {"passive","face","modify_card"},
	rarity = "fusion",
	unlocked = true,
	discovered = true,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","chips","hand_size"},
	pos = { x = 8, y = 6 },
	cost = 14,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","xmult","food"},
	pos = { x = 2, y = 15 },
	cost = 12,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","retrigger"},
	pos = { x = 9, y = 6 },
	cost = 14,
	config = { extra = 2 },
...
SMODS.Joker {
	...
	key = "cryomancer",
	atlas = "Tsunami",
	attributes = {"passive","tarot","generation"},
	pos = { x = 7, y = 3 },
...
SMODS.Joker {
	...
	key = "toaster",
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","retrigger","two","three","four","five"},
	pos = { x = 5, y = 2 },
...
SMODS.Joker {
	...
	key = "surfboard",
	atlas = "Tsunami",
	attributes = {"passive","suit","xmult","spades","clubs"},
	pos = { x = 2, y = 10 },
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","full_deck","xmult","enhancements"},
	pos = { x = 7, y = 2 },
	cost = 20,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","extra_scored_cards","xmult","king","enhancements"},
	pos = { x = 6, y = 12 },
	cost = 20,
...
SMODS.Joker {
	...
	discovered = true,
	atlas = 'Tsunami',
	attributes = {"passive","extra_scored_cards","mult","scaling","hand_type"},
	cost = 20,
	blueprint_compat = true,
	perishable_compat = false,
	pos = { x = 4, y = 15 },
...
SMODS.Joker {
	...
	discovered = true,
	atlas = 'Tsunami',
	attributes = {"passive","extra_scored_cards","enhancements","scaling","chips","mult"},
	cost = 20,
	blueprint_compat = true,
	perishable_compat = false,
	pos = { x = 9, y = 0 },
...
SMODS.Joker {
	...
	discovered = true,
	atlas = 'Tsunami',
	attributes = {"passive","extra_scored_cards","modify_card","enhancements"},
	cost = 20,
	blueprint_compat = true,
	perishable_compat = false,
	pos = { x = 3, y = 2 },
...
SMODS.Joker {
	...
	discovered = true,
	atlas = 'Tsunami',
	attributes = {"passive","suit","economy"},
	cost = 20,
	blueprint_compat = true,
	perishable_compat = true,
	pos = { x = 4, y = 11 },
...
SMODS.Joker {
	...
	blueprint_compat = true,
	atlas = "Tsunami",
	attributes = {"passive","xmult","xchips","scaling","enhancements"},
	pos = { x = 0, y = 7 },
	cost = 18,
...
SMODS.Joker {
	...
	blueprint_compat = true,
	pos = { x = 6, y = 11 },
	config = { xmult = 4, dollars = 1 },
	loc_vars = function(self, info_queue, card)
		return { vars = { card.ability.xmult, card.ability.dollars } }
	end,
	calculate = function(self, card, context)
		...
		if context.individual and context.cardarea == G.play then
			if context.other_card.ability.cardshark_tsunami == true then
				return {
					dollars = card.ability.dollars
				}
			end
...
FusionJokers.fusions:register_fusion {
	jokers = {
		{ name = "j_splash" },
		{ name = "j_card_sharp" },
	}, cost = 14, result_joker = "j_tsun_card_shark"
}

---hook for card shark's effect
-- cards are set to played this ante before I can check them otherwise - this hook is needed to beat the vanilla code to the punch

local G_FUNCS_play_cards_from_highlighted_ref = G.FUNCS.play_cards_from_highlighted
G.FUNCS.play_cards_from_highlighted = function(e)
	for i = 1, #G.hand.highlighted do
		G.hand.highlighted[i].ability.cardshark_tsunami = not (not G.hand.highlighted[i].ability.played_this_ante)
	end
...
SMODS.Joker {
	...
	pos = { x = 9, y = 12 },
	config = { extra = { Xmult_gain = 0.25, x_mult = 1 } },
	loc_vars = function(self, info_queue, card)
		return { vars = { card.ability.extra.Xmult_gain, card.ability.extra.x_mult } }
	end,
	calculate = function(self, card, context)
		if context.before and not context.blueprint then
			local reset = false
...
FusionJokers.fusions:register_fusion {
	...
	}, cost = 9, result_joker = "j_tsun_lighthouse"
}
